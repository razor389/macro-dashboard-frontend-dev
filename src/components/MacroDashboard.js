...
const MacroDashboard = () => {
  ...
  return (
    <div className="p-6 max-w-7xl mx-auto">
        ...
        <div className="space-y-4">
          ...
          <div className="bg-gray-50 p-4 rounded-lg shadow">
            ...
            <div className="grid grid-cols-1 gap-4">
              ...
              <div className="p-4 bg-white rounded shadow-sm">
                <p className="text-gray-600">Estimated Bond Return (=20-yr Bond Yield + Δ Inflation + Δ Growth)</p>
                <p className="text-xl font-bold text-blue-600">
                  {estimatedBondReturn !== null ? `${estimatedBondReturn}%` : 'N/A'}
                </p>
              </div>
            </div>
          </div>
        ...
        <div className="space-y-4">
          ...
          <div className="bg-white p-6 rounded-lg shadow">
            ...
            <div className="grid grid-cols-2 gap-4">
              ...
              <div className="p-4 bg-gray-50 rounded">
                <p className="text-gray-600">Current Dividend Yield</p>
                <p className="text-xl font-bold text-blue-600">
                  {data.equity?.current_sp500_price && data.equity?.ttm_dividend ? 
                    `${((data.equity.ttm_dividend.value / data.equity.current_sp500_price) * 100).toFixed(2)}%` : 'N/A'}
                </p>
              </div>
              <div className="p-4 bg-gray-50 rounded">
              ...
              <div className="p-4 bg-gray-50 rounded">
                <p className="text-gray-600">Current ROE</p>
                <p className="text-xl font-bold text-blue-600">
                  {data.equityMetrics?.current_returns_cagr && data.equityMetrics?.current_cape_cagr ? 
                    `${((data.equityMetrics.current_returns_cagr - data.equityMetrics.current_cape_cagr) * 100).toFixed(2)}%` : 'N/A'}
                </p>
              </div>
            </div>
          </div>
          ...
          <div className="bg-white p-4 rounded-lg shadow">
            <h2 className="text-xl font-semibold mb-3">Parameters & Expectations</h2>
            <div className="grid grid-cols-2 gap-3">
              ...
              {[
                ...
                { label: 'Expected Market Return', value: metrics?.expectedMarketReturn?.toFixed(2), suffix: '%' }
      ...
      {/* Bottom Section - Equity Risk Premium */}
      <div className="mt-6 bg-white p-8 rounded-lg shadow-lg mx-auto max-w-2xl">
